          ...
          <form novalidate="">
            <div class="form-group mb-3 text-center">
              <label class="form-label">
                В качестве логина будет использоваться Ваш: <br> БИН - для организаций <br> ИИН для физических лиц
              </label>
            </div>
            ...
            <div class="form-group mb-3">
              ...
              <input id="confirm_password" type="password" class="form-control" name="confirm">
              <div class="invalid-feedback">
                Повторите пароль is invalid
              </div>
            </div>

            <div class="form-group">
              <label class="form-label">ЭПЦ</label>
              <button  class="btn_primary btn_block"
                      @click.prevent="runNca">
...
export default {
  ...
  methods: {
    ...
    async sendKey() {
      try {
        if (this.user.password === this.confirm_password && this.xmlKey) {
